...
/* Additional Variables for the */

#define RECORD_LIMIT 15 //seconds
#define SAMPLERATE 48000 //sample rate 
#define MEMSIZE (SAMPLERATE * RECORD_LIMIT) //total amount of memory allocated for recording 
#define CLOCKRATE 333000000 // zynq clockrate
#define SAMPLEPERIOD (CLOCKRATE/SAMPLERATE)  //

extern XTime TStart;
extern XTime TEnd;

//buffers to save audio in memory
extern u32 LeftAudioBuffer[MEMSIZE];
extern u32 RightAudioBuffer[MEMSIZE];
